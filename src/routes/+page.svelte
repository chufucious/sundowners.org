  ...
  <div class="grid grid-cols-12 gap-4">
    ...
    <div class="col-start-2 col-span-10 md:col-start-3 md:col-span-5">
      ...
      <h2 class="text-xl md:text-2xl text-orange-950 mb-4 font-garamond">
        ...
        and speakeasies bring to the world.
      </h2>
      <p
      ...
      >
        ...
        African-based music is our creative North Star.<br /><br />We flavor our
        experience through Afrofuturism, imagining a positive, inclusive future
        through speculative art and technology, representing the diverse
        background and skills of our community.
      </p>
    </div>
    <div class="col-start-2 col-span-10 md:col-start-8 md:col-span-3 md:pl-16">
      <aside
          ...
          <tr>
            ...
            <td
              ><a
                ...
                class="underline hover:text-orange-500">Curiouser & Curiouser</a
              ></td
            >
            <td>Rest year</td>
          </tr>
