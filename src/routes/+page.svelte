...
<section class="bg-cyan-500">hello</section>
...
<section class="mt-24 mb-24 mx-auto text-center p-8">
  ...
  >
    We are an African-diaspora inspired art collective named after 'Sundowners'
    - a wonderful South African tradition of sharing stories, laughter, and
    libations at dusk. We feel Burning Man, as the world’s largest temporary
    city, is a fitting ecosystem to explore a unique ethnographic heritage that
    has expressed itself across Africa, America, South America, and the
    Caribbean. At the highest level, we aim to directly challenge nationalism
    through our unique expression of diversity.
  </p>
</section>
...
<section class="mt-24 mb-24 mx-auto text-center p-8">
  ...
  >
    ...
    speakeasies bring to the world. We strive for a holistic offering through
    our shebeen speakeasy and safari-theme art car. However, the deep artistry,
    meaning, and humanity of African-based music is our creative North Star. We
    flavor our experience through Afrofuturism, imagining a positive, inclusive
...
<section class="flex">
  <img
    srcset={rexanjump}
    sizes="(min-width: 640px) 640px, (min-width: 1024px) 1200px"
    alt="rexan crew jumping"
    class="w-full h-auto"
  />
</section>
...
<section class="mt-24 mb-24 mx-auto text-center p-8">
  ...
  <p
    class="font-mono text-md text-stone-900 leading-relaxed max-w-prose mx-auto"
  >
    Our veteran multi-continental crew offers an experience, interactivity, and
    vibe that is distinct from anything in Black Rock. At every step, we strive
    to share the wonder and appreciation for one of the most special places on
    the planet, much like Burning Man itself.
  </p>
</section>
...
<section class="mt-24 mb-24 mx-auto text-center p-8">
  ...
  >
    ...
    globe traveled to South Africa and went on a life-changing wildlife safari.
    On the Savannah, we would end each day with the country’s lovely sunset
    social ceremony. That same year, we dubbed ourselves Sundowners and created
    Rexan, a psychedelic safari-themed art car to bring this special cultural
...
<section class="mt-24 mb-24 mx-auto text-center p-8">
  ...
  >
    ...
    vision through our flavor of African diaspora events, creative projects, and
    community involvement. If you would like to participate as a musician, DJ,
    dancer, artist or in any creative capacity we would love to hear from you.
  </p>
</section>
